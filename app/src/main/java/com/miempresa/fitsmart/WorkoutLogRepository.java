...
public class WorkoutLogRepository {
    ...
    public List<WorkoutLog> getLogsByExercise(int userId, int exerciseId) {
        ...
        Cursor cursor = db.rawQuery(
                "SELECT id, user_id, exercise_id, date, weight, reps, sets " +
                        ...
                        "ORDER BY date ASC", new String[]{String.valueOf(userId), String.valueOf(exerciseId)});
    ...
    public int getTimesExerciseDone(int userId, int exerciseId) {
        ...
        Cursor cursor = db.rawQuery(
                "SELECT COUNT(*) " +
                        "FROM workout_logs " +
                        "WHERE user_id = ? AND exercise_id = ?", new String[]{String.valueOf(userId), String.valueOf(exerciseId)});
    ...
    public double getMaxWeight(int userId, int exerciseId) {
